 ...
 * TabView的测试与使用
 */
public class TabViewTestActivity extends AppCompatActivity {
...
//                Intent intent = new Intent(TabViewTestActivity.this, CustomSnakeBarTestActivity.class);
//                Intent intentCamera = new Intent(TabViewTestActivity.this, CameraHelperTestActivity.class);
//                Intent intentCameraWonderful = new Intent(TabViewTestActivity.this,WonderfulCameraActivity.class);
            ...
            if (grantResults.length >0){
                for (int result:grantResults){
                    if (result != PackageManager.PERMISSION_GRANTED){
                        Toast.makeText(TabViewTestActivity.this,"对不起，您拒绝了权限无法使用此功能！",Toast.LENGTH_SHORT).show();
                        return;
                    }
                }
                //开启预览
            }else {
                Toast.makeText(TabViewTestActivity.this,"发生未知错误！", Toast.LENGTH_SHORT).show();
            }
        }
    }
